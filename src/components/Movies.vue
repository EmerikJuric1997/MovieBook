  ...
  <div class="cardcomponent">
    <v-row>
      ...
      <v-row class="justify-center">
        <v-col
          cols="12" sm="2" md="2" xl="2" xxl="2"
          v-for="smovie in moviesearch"
          :key="smovie.imdbID"
          class="align-center text-center justify-center mx-auto justify-content-center mx-auto"
        >
          <v-card rounded class="ma-4" width="200">
            <router-link
              :to="{ name: 'MovieDetails', params: { id: smovie.imdbID } }"
            >
              <v-img class="searchmoviehome" :src="smovie.Poster" cover></v-img>
            </router-link>
          </v-card>
        </v-col>
      </v-row>
